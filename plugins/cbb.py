            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton("ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ", url="https://t.me/RaveFire_Series")
                    ],
                    [
                        InlineKeyboardButton("Anime", url="https://t.me/Anime_Fury"),
                        InlineKeyboardButton("Ongoing Anime", url="https://t.me/Ongoing_Fury")
                    ],
                    [
                        InlineKeyboardButton("ʜᴀɴɪᴍᴇ&ʜ*ɴᴛᴀɪ", url="https://t.me/Adult_Fury"),
                        InlineKeyboardButton("🔒ᴄʟᴏꜱᴇ", callback_data='close')
                    ]
                ]
            )
