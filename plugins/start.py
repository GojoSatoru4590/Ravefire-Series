        ...
        try:
            ...
            if basic.startswith("yu3elk"):
                ...
                if user_id in user_timeouts and (asyncio.get_event_loop().time() - user_timeouts[user_id]) < 130:
                    await message.reply("<b><blockquote>🚨 ʙʏᴘᴀss ᴅᴇᴛᴇᴄᴛᴇᴅ 🚨</blockquote>\n\n<blockquote>🔮 ᴏʜ ᴍʏ!\n\nᴀʀᴇ ʏᴏᴜ ᴅᴏɪɴɢ ʙʏᴘᴀss, sᴏʀʀʏ ᴛᴏ ʙʀɪɴɢ ʏᴏᴜ ᴅᴏᴡɴ. ɢᴏ ʙᴀᴄᴋ ᴀɴᴅ sᴏʟᴠᴇ ɪᴛ ʙʏ ʏᴏᴜʀ ᴏᴡɴ ᴍʏ ғʀɪᴇɴᴅ, ᴅᴏɴ'ᴛ ᴀᴄᴛ sᴍᴀʀᴛ 🍹</blockquote></b>")
                    return
    ...
    try:
        ...
        buttons = [
            [
                ...
                InlineKeyboardButton(text="Tutorial", url="https://t.me/+a5wbqLeZuhc4YzA1")
            ],
            [
